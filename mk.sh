...
g++ -o examples/Lenna/Lenna -x c++ examples/Lenna/Lenna.ino SDL2NovaVGA.cpp -I. -D_GNU_SOURCE=1 -D_REENTRANT -lSDL2 -Wall
...
g++ -o examples/Rgb222/Rgb222 -x c++ examples/Rgb222/Rgb222.ino SDL2NovaVGA.cpp -I. -D_GNU_SOURCE=1 -D_REENTRANT -lSDL2 -Wall
